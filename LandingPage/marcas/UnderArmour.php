<?php
    ...
    $underArmour_children = [
        (object)[
            "id" => "n041",
            "code" => "Cod.N041",
            "price" => 250000,
            "priceFormat" => "$250.000cop",
            "img" => "../img/underArmour/n1.png"
        ],
        (object)[
            "id" => "n042",
            "code" => "Cod.N042",
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $marca = "Under Armour"; // Asignar la marca correspondiente
...
<body>
    ...
    <section class="grid">
        ...
        <div class="underArmour">
            ...
            <div></div>
            <?php
                foreach ($underArmour_children as $product) {
                    echo '<div class="n">';
    ...
    <div class="underArmour-fem">
        ...
        <div class="mujer">
            ...
            <div></div>
            <?php
                foreach ($underArmour_women as $product) {
                    echo '<div class="m">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
    ...
    <div class="underArmour-men">
        ...
        <div class="hombre">
            ...
            <div></div>
            <?php
                foreach ($underArmour_men as $product) {
                    echo '<div class="h">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
