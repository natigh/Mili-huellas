<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $marca = "Reebok"; // Asignar la marca correspondiente
...
<body>
    ...
    <section class="grid">
        ...
        <div class="reebok">
            ...
            <div></div>
            <?php
                foreach ($rebook_children as $product) {
                    echo '<div class="n">';
    ...
    <div class="reebok-fem">
        ...
        <div class="mujer">
            ...
            <div></div>
            <?php
                foreach ($rebook_women as $product) {
                    echo '<div class="m">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
