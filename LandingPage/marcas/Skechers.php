<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $marca = "Skechers"; // Asignar la marca correspondiente
...
<body>
    ...
    <section class="grid">
        ...
        <div class="skechers">
            ...
            <div></div>
            <?php
                foreach ($skechers_children as $product) {
                    echo '<div class="n">';
    ...
    <div class="skechers-fem">
        ...
        <div class="mujer">
            ...
            <div></div>
            <?php
                foreach ($skechers_women as $product) {
                    echo '<div class="m">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
    ...
    <div class="skechers-men">
        ...
        <div class="hombre">
            ...
            <div></div>
            <?php
                foreach ($skechers_men as $product) {
                    echo '<div class="h">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
