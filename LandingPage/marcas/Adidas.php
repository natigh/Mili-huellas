...
<body>
    ...
    <section class="grid">
        ...
        <div class="adidas">
            ...
            <div></div>
            <?php
                foreach ($adidas_children as $product) {
                    echo '<div class="n">';
                    ...
                    echo '<input type="hidden" name="marca" value="' . $product->img . '">';
    ...
    <div class="adidas-fem">
        ...
        <div class="mujer">
            ...
            <div></div>
            <?php
                foreach ($adidas_women as $product) {
                    echo '<div class="m">';
                    echo '<img src="' . $product->img . '" alt="' . $product->id . '">';
                    echo '<h3>' . $product->code . '</h3>';
                    echo '<h3>' . $product->priceFormat . '</h3>';
